      ...
      <div className="container mx-auto px-4 py-3 md:py-4">
        ...
        <div className="hidden lg:flex items-center justify-between gap-6">
          ...
          <div className="w-full lg:flex-1 lg:max-w-2xl relative order-3 lg:order-2">
            <form onSubmit={handleSearchSubmit} className="relative search-bar-entrance group">
              <input
                ...
                onChange={(e) => handleSearch(e.target.value)}
                onFocus={() => setShowSearch(true)}
                placeholder={t('header.searchPlaceholderLong')}
              ...
              {searchResults.length > 0 ? (
                <>
                  <div className="bg-gradient-to-r from-red-600 to-red-700 text-white px-4 py-3 flex items-center justify-between">
                    <div>
                      <p className="font-bold text-sm">{t('header.searchResults')}</p>
                      <p className="text-xs text-red-100">
                        {searchResults.length}{' '}
                        {searchResults.length === 1
                          ? t('header.productFound')
                          : t('header.productsFound')}
                      </p>
                    </div>
                  ...
                  {searchResults.length > 0 && (
                    ...
                    >
                      <p className="text-sm font-semibold text-gray-700">
                        ...
                        {t('header.pressEnterToSeeAll')}
                      </p>
                      <p className="text-xs text-gray-500">{t('header.advancedSearch')}</p>
                    </button>
                  )}
                </>
              ) : isSearchVisible ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500">{t('header.tryOtherTerms')}</p>
                  <div className="mt-4 text-xs text-gray-400">
                    <p>{t('header.searchHint')}</p>
                  </div>
                </div>
              ) : null}
            </div>
          ...
          <nav className="flex items-center gap-2 md:gap-4 flex-shrink-0 order-2 lg:order-3">
            <LanguageSelector variant="desktop" tone="dark" className="hidden md:block" />
                ...
                <div className="bg-gradient-to-br from-white to-gray-50 text-black shadow-2xl rounded-2xl overflow-hidden border-2 border-gray-200">
                  ...
                  <div className="bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-black">{t('header.ourCategories')}</h3>
                        <p className="text-xs text-red-100">
                          {t('header.categoriesTagline')}
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-xs font-medium transition-colors duration-300 text-gray-500 group-hover:text-red-700">
                              {productCount}{' '}
                              {productCount === 1 ? t('common.product') : t('common.products')}
                            </span>
      ...
      >
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 p-5 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black text-base">{t('header.menu')}</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {/* Seletor de idioma */}
          <LanguageSelector variant="mobile" tone="dark" className="justify-between" />
          ...
          >
            ...
            <span className="text-sm">{t('header.accessCatalog')}</span>
          </button>

          {/* Divisor */}
          <div className="border-t border-gray-700 pt-4">
            <h4 className="font-black text-xs text-gray-400 mb-3 px-2">
              {t('header.categoriesUpper')}
            </h4>
        ...
        <div className="p-4 border-t border-gray-800 flex-shrink-0 bg-black/50">
          <div className="text-center">
            <p className="text-xs text-gray-400 mb-2">{t('header.contactUs')}</p>
